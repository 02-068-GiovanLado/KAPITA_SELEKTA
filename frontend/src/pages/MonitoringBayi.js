...
import './MonitoringBayi.css';

function MonitoringBayi() {
  const [bayiPatients, setBayiPatients] = useState([]);
  ...
  if (loading) return <div className="monitoring-bayi"><div className="loading">Loading...</div></div>;
